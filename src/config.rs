...
pub const BG_COLOR: Color = BROWN;
...
pub const ENEMY_COLOR: Color = BLACK;
pub const ENEMY_BORDER_COLOR: Color = Color::new(1.0, 0.5, 0.5, 1.0); // TODO: hex
...
pub const PLAYER_COLOR: Color = BLACK;
pub const PLAYER_BORDER_COLOR: Color = WHITE;
pub const PLAYER_BASE_SPEED: f32 = 300.0; // pixels-per-second with dt

pub const WALL_COLOR: Color = Color::from_hex(0x451911);
