...
// Arena
pub const ARENA_MIN_ENEMIES_COUNT: usize = 8;
...
pub const SCRAWLER_BORDER_THICKNESS: f32 = 2.5;
pub const SCRAWLER_INITIAL_LIFE: f32 = 100.0;
pub const SCRAWLER_BASE_SPEED: f32 = 120.0;
pub const SCRAWLER_COG_DROP_QUANT_MIN: usize = 1;
pub const SCRAWLER_COG_DROP_QUANT_MAX: usize = 3;
pub const SCRAWLER_WALK_SPEED_MULT: f32 = 12.0;
pub const SCRAWLER_LEG_COUNT: usize = 3;
pub const SCRAWLER_INJURED_DURATION: f32 = 0.05; // seconds
pub const SCRAWLER_BORDER_COLOR: Color = Color::from_hex(0x12141a);
pub const SCRAWLER_BODY_COLOR: Color = Color::from_hex(0x5a524a);
pub const SCRAWLER_METAL_COLOR: Color = Color::from_hex(0xc8c8c8);
pub const SCRAWLER_VISOR_COLOR: Color = Color::from_hex(0x00e5ff);
pub const SCRAWLER_INJURED_COLOR: Color = LIGHTGRAY;

// Leechy
pub const LEECHY_RADIUS: f32 = 14.0;
pub const LEECHY_BASE_SPEED: f32 = 65.0;
pub const LEECHY_INITIAL_LIFE: f32 = 60.0;
pub const LEECHY_INJURED_DURATION: f32 = 0.05;
pub const LEECHY_BLOOD_POOL_DROP_QUANT_MIN: usize = 4;
pub const LEECHY_BLOOD_POOL_DROP_QUANT_MAX: usize = 6;
pub const LEECHY_BLOOD_POOL_DROP_SPREAD: f32 = 1.5;
pub const LEECHY_TRAIL_INTERVAL: f32 = 0.3;
pub const LEECHY_BODY_COLOR: Color = Color::from_hex(0x8b0000);
pub const LEECHY_TENTACLE_COLOR: Color =  Color::from_hex(0xff4d4d);
pub const LEECHY_SHADOW_COLOR: Color = Color::new(0.0, 0.0, 0.0, 0.4);
pub const LEECHY_EYE_BASE_COLOR: Color = BLACK;
pub const LEECHY_EYE_GLOSS_COLOR: Color = WHITE;
pub const LEECHY_INJURED_COLOR: Color = WHITE;

// Blood Pool
pub const BLOOD_POOL_RADIUS: f32 = 15.0;
pub const BLOOD_POOL_LIFETIME: f32 = 3.0;
pub const BLOOD_POOL_COLOR: Color = Color::from_hex(0x5a0000);
